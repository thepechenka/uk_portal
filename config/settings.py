...
SECRET_KEY = os.getenv('DJANGO_SECRET_KEY', 'django-insecure-3x#g!z@8k$9m&p2s5v7y*a(b+d)f-hj')
DEBUG = True
...
ACCOUNT_EMAIL_SUBJECT_PREFIX = 'Управляющая компания ООО "Новый город"'
